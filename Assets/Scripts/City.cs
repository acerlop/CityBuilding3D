...
public class City : MonoBehaviour
{
    ...
    {
        statsText.text = String.Format("Day:{0} Money:{1} Pop:{2}/{3} Jobs:{4}/{5} Food:{6} Health:{7} Energy:{8} Polution:{9}", new object[10] { day, money, curPopulation, maxPopulation, curJobs, maxJobs, curFood, curHealth, curEnergy, curPolution});
    ...
    private void CalculateEnergy()
    {
        ...
        foreach (Building building in buildings)
            curEnergy += building.preset.energy;
    }
    ...
    private void CalculatePolution()
    {
        ...
        foreach (Building building in buildings)
            curPolution += building.preset.polution;
    }
